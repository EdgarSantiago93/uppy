    ...
    "../node_modules/marked/lib/marked.js"(exports, module) {
      (function(root) {
        ...
        Lexer.prototype.token = function(src, top) {
          src = src.replace(/^ +$/gm, "");
          var next, loose, cap, bull, b2, item, listStart, listItems, t2, space, i2, tag, l2, isordered, istask, ischecked;
          while (src) {
            ...
            if (cap = this.rules.nptable.exec(src)) {
              ...
              if (item.header.length === item.align.length) {
                src = src.substring(cap[0].length);
                for (i2 = 0; i2 < item.align.length; i2++) {
                ...
                for (i2 = 0; i2 < item.cells.length; i2++) {
                  item.cells[i2] = splitCells(item.cells[i2], item.header.length);
                }
            ...
            if (cap = this.rules.list.exec(src)) {
              ...
              for (; i2 < l2; i2++) {
                ...
                if (i2 !== l2 - 1) {
                  b2 = block.bullet.exec(cap[i2 + 1])[0];
                  if (bull.length > 1 ? b2.length === 1 : b2.length > 1 || this.options.smartLists && b2 !== bull) {
                    src = cap.slice(i2 + 1).join("\n") + src;
                    i2 = l2 - 1;
                  }
                }
                loose = next || /\n\n(?!\s*$)/.test(item);
            ...
            if (cap = this.rules.table.exec(src)) {
              ...
              if (item.header.length === item.align.length) {
                ...
                for (i2 = 0; i2 < item.cells.length; i2++) {
                  item.cells[i2] = splitCells(item.cells[i2].replace(/^ *\| *| *\| *$/g, ""), item.header.length);
                }
                this.tokens.push(item);
                continue;
              }
        ...
        InlineLexer.prototype.mangle = function(text) {
          if (!this.options.mangle)
            return text;
          var out = "", l2 = text.length, i2 = 0, ch;
          for (; i2 < l2; i2++) {
        ...
        Parser.prototype.tok = function() {
          switch (this.token.type) {
            ...
            case "table": {
              var header = "", body = "", i2, row, cell, j2;
              cell = "";
              for (i2 = 0; i2 < this.token.header.length; i2++) {
                cell += this.renderer.tablecell(this.inline.output(this.token.header[i2]), {
                  header: true,
                  align: this.token.align[i2]
                });
              }
              header += this.renderer.tablerow(cell);
              for (i2 = 0; i2 < this.token.cells.length; i2++) {
                row = this.token.cells[i2];
                cell = "";
                for (j2 = 0; j2 < row.length; j2++) {
                  cell += this.renderer.tablecell(this.inline.output(row[j2]), {
                    header: false,
                    align: this.token.align[j2]
                  });
                }
        ...
        function unescape2(html) {
          return html.replace(/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig, function(_2, n2) {
            n2 = n2.toLowerCase();
            if (n2 === "colon")
              return ":";
            if (n2.charAt(0) === "#") {
        ...
        function marked2(src, opt, callback) {
          ...
          if (callback || typeof opt === "function") {
            ...
            var highlight = opt.highlight, tokens, pending, i2 = 0;
            try {
  ...
  var require_drag_drop = __commonJS({
    "../node_modules/drag-drop/index.js"(exports, module) {
      ...
      function dragDrop(elem, listeners) {
        ...
        function onDragEnter(e2) {
          if (listeners.onDragEnter) {
            listeners.onDragEnter(e2);
          }
          e2.stopPropagation();
          e2.preventDefault();
          return false;
        ...
        function onDragOver(e2) {
          ...
          if (listeners.onDragOver) {
            listeners.onDragOver(e2);
          }
          if (e2.dataTransfer.items) {
            var items = Array.from(e2.dataTransfer.items);
        ...
        function onDrop(e2) {
          ...
          var text = e2.dataTransfer.getData("text");
          if (text && listeners.onDropText) {
            listeners.onDropText(text, pos);
          }
          if (listeners.onDrop && e2.dataTransfer.items) {
            var fileList = e2.dataTransfer.files;
            var items = Array.from(e2.dataTransfer.items).filter(function(item) {
              return item.kind === "file";
            });
            if (items.length === 0)
              return;
...
Uppy plugins must have unique \`id\` options. See https://uppy.io/docs/plugins/#id.`;
      ...
      function _checkRequiredMetaFieldsOnFile2(file) {
        ...
        for (let i2 = 0; i2 < requiredMetaFields.length; i2++) {
          if (!hasOwnProperty.call(file.meta, requiredMetaFields[i2]) || file.meta[requiredMetaFields[i2]] === "") {
  ...
  var require_lib3 = __commonJS({
    "../node_modules/get-form-data/lib/index.js"(exports) {
      ...
      function getFormData(form) {
        ...
        for (var i2 = 0, l2 = form.elements.length; i2 < l2; i2++) {
          var element = form.elements[i2];
      ...
      function getFieldData(form, fieldName) {
        ...
        var data = [];
        var allRadios = true;
        for (var i2 = 0, l2 = element.length; i2 < l2; i2++) {
          if (element[i2].disabled) {
            continue;
          }
          if (allRadios && element[i2].type !== "radio") {
            allRadios = false;
          }
          var value = getFormElementValue(element[i2], options.trim);
          if (value != null) {
      ...
      function getFormElementValue(element, trim) {
        ...
        if (type === "select-multiple") {
          value = [];
          for (var i2 = 0, l2 = element.options.length; i2 < l2; i2++) {
            if (element.options[i2].selected) {
              value.push(element.options[i2].value);
            }
          }
          if (value.length === 0) {
            value = null;
...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e3.byteLength}`), e3.tiff && await e3.ensureChunk(this.ifd0Offset, o2(this.options));
  ...
  var require_is_binary = __commonJS({
    "../node_modules/socket.io-client/node_modules/socket.io-parser/build/cjs/is-binary.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
  ...
  var require_binary = __commonJS({
    "../node_modules/socket.io-client/node_modules/socket.io-parser/build/cjs/binary.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
  ...
  var require_cjs3 = __commonJS({
    "../node_modules/socket.io-client/node_modules/socket.io-parser/build/cjs/index.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", {
        value: true
      });
  ...
  var require_lib18 = __commonJS({
    "../packages/@uppy/url/lib/index.js"(exports, module) {
      ...
      module.exports = (_temp = _class = class Url extends UIPlugin {
        ...
        canHandleRootDrop(e2) {
          const items = toArray(e2.dataTransfer.items);
          const urls = items.filter((item) => item.kind === "string" && item.type === "text/uri-list");
          return urls.length > 0;
        }
        handleRootDrop(e2) {
          forEachDroppedOrPastedUrl(e2.dataTransfer, "drop", (url) => {
            this.uppy.log(`[URL] Adding file from dropped url: ${url}`);
            this.addFile(url);
          });
        }
        handleRootPaste(e2) {
          forEachDroppedOrPastedUrl(e2.clipboardData, "paste", (url) => {
